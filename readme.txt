...
Pi-Fi Gallery is an open source project that utilizes an Eye-Fi card for your digital camera and a $35 Raspberry Pi computer.  When a picture is taken on your digital camera, the Eye-Fi card transmits the files to the Raspberry Pi, which in turn uploads the images to your web gallery for all to share.  Configuration mainly consists of copying all of the files in this project to your own personal web server and running a few commands on the Raspberry Pi.
