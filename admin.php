<?php
	...
	*/
	...
	option('TEXT_GALLERY_NAME', 'Pi-Fi Gallery Administration');
	option('TEXT_BANNER', '<h3><a href="pifiadmin.php">Configure uploaders & users</a></h3>');
