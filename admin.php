<?php
	...
	*/
	...
	$file_exclude = array();
	$file_ext_exclude = array('.php', '.txt', '.sell', '.gz');
	...
	define('TEXT_GALLERY_NAME', 'Pi-Fi Gallery Administration');
	define('TEXT_BANNER', '<h3><a href="pifiadmin.php">Configure uploaders & users</a></h3>');
